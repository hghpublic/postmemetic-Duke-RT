...
if(PROFILE STREQUAL "PRODUCTION" AND NOT _canonical_count EQUAL 202)
	message(FATAL_ERROR "Production NRI shader set must contain exactly 202 canonical blobs; found ${_canonical_count}")
endif()
foreach(_transient_pass Clear BuildBins LightBuild Materialize)
	foreach(_backend dxil spirv)
		if(NOT EXISTS "${SHADER_DIR}/SmokeTransient${_transient_pass}.cs.${_backend}")
			message(FATAL_ERROR "Missing transient smoke shader: SmokeTransient${_transient_pass}.cs.${_backend}")
		endif()
	endforeach()
endforeach()
