...
public:
	...
	struct FrameBoundaryDebugStats
	{
		...
		uint64_t submittedFenceValue = 0;
		uint64_t admissionTargetFenceValue = 0;
		uint64_t admissionCompletedFenceBefore = 0;
		uint64_t admissionCompletedFenceAfter = 0;
		...
		uint32_t acquireSemaphoreIndex = 0;
		uint32_t renderedFrameLimit = QueuedFrameCount;
		uint32_t physicalQueuedFrameCount = QueuedFrameCount;
		uint32_t outstandingBeforeAdmission = 0;
		uint32_t outstandingAfterAdmission = 0;
		bool admissionFenceSnapshotValid = false;
