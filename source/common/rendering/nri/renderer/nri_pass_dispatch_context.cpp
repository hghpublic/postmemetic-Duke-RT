...
NRIPassDispatchContext::NRIPassDispatchContext(const Init& init)
	...
	mTemporalReactiveInputSet(*init.temporalReactiveInputSet),
	mTemporalReactiveOutputSet(*init.temporalReactiveOutputSet),
	...
	mMapMotionHistory(*init.mapMotionHistory),
	mNrd(*init.nrd),
