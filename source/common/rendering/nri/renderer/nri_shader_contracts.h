...
constexpr uint32_t NRI_SCENE_DATA_DESCRIPTOR_NUM = 29;
constexpr uint32_t NRI_SCENE_DATA_STATIC_TANGENT_SLOT = 28;
constexpr uint32_t NRI_TRACE_AUX_STATIC_TANGENT_SHIFT = 6;
constexpr uint32_t NRI_TRACE_AUX1_STATIC_TANGENT_MASK = 3u << NRI_TRACE_AUX_STATIC_TANGENT_SHIFT;
constexpr uint32_t NRI_TRACE_AUX_DENOISER_MASK = 0x3fu;
...
static_assert(sizeof(NRIVoxelComputePrimitiveData) == 88, "NRIVoxelComputePrimitiveData must match VoxelComputeConstants.hlsli.");
