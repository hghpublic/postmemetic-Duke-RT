...
static constexpr uint32_t NRI_TRACE_SHADER_STAT_COUNT = NRI_TRACE_SHADER_RESPONSE_LOOKUP_BASE + 5;
...
static_assert(NRI_TRACE_SHADER_RESPONSE_LOOKUP_ORACLE_ITERATIONS + 1u == NRI_TRACE_SHADER_STAT_COUNT);
