...
static constexpr uint32_t NRI_TRACE_SHADER_STAT_COUNT = NRI_TRACE_SHADER_ABSENCE_PROFILE_BASE + NRI_TRACE_SHADER_ABSENCE_PROFILE_COUNT;
...
static_assert(NRI_TRACE_SHADER_STAT_COUNT == 9070);
