...
static constexpr uint32_t NRI_TRACE_SHADER_STAT_COUNT = NRI_TRACE_SHADER_PROFILE_BASE + NRI_TRACE_SHADER_PROFILE_COUNT;
...
static_assert(NRI_TRACE_SHADER_PROFILE_EMISSIVE_RESPONSE_SCAN_MAX_ITERATIONS + 1u == NRI_TRACE_SHADER_STAT_COUNT);
