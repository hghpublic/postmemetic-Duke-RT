...
static constexpr uint32_t NRI_TRACE_SHADER_STAT_COUNT = NRI_TRACE_SHADER_PRIMARY_GEOMETRY_ORACLE_BASE + 7;
...
static_assert(NRI_TRACE_SHADER_PRIMARY_GEOMETRY_ORACLE_IDENTITY + 1u == NRI_TRACE_SHADER_STAT_COUNT);
