...
NRISmokeSettings BuildNRISmokeSettingsFromCVars()
{
	...
	settings.visuals.thermalLow = std::clamp((float)nri_ptsmokethermallow, 0.0f, 64.0f);
	settings.visuals.thermalHigh = std::clamp((float)nri_ptsmokethermalhigh, 0.0f, 64.0f);
	settings.visuals.thermalTint[0] = std::clamp((float)nri_ptsmokethermaltintr, 0.0f, 2.0f);
	settings.visuals.thermalTint[1] = std::clamp((float)nri_ptsmokethermaltintg, 0.0f, 2.0f);
	settings.visuals.thermalTint[2] = std::clamp((float)nri_ptsmokethermaltintb, 0.0f, 2.0f);
	settings.visuals.thermalGlow[0] = std::clamp((float)nri_ptsmokethermalglowr, 0.0f, 4.0f);
	settings.visuals.thermalGlow[1] = std::clamp((float)nri_ptsmokethermalglowg, 0.0f, 4.0f);
	settings.visuals.thermalGlow[2] = std::clamp((float)nri_ptsmokethermalglowb, 0.0f, 4.0f);
	settings.visuals.gradientPivot = std::clamp((float)nri_ptsmokegradientpivot, 0.0f, 4.0f);
	settings.visuals.gradientWidth = std::clamp((float)nri_ptsmokegradientwidth, 0.001f, 4.0f);
	settings.visuals.edgeSculpt = std::clamp((float)nri_ptsmokeedgesculpt, -1.0f, 1.0f);
	settings.visuals.edgePowder = std::clamp((float)nri_ptsmokeedgepowder, -1.0f, 1.0f);
	settings.visuals.edgeTint[0] = std::clamp((float)nri_ptsmokeedgetintr, 0.0f, 2.0f);
	...
	settings.visuals.thicknessStrength = std::clamp((float)nri_ptsmokethicknessstrength, -1.0f, 1.0f);
	settings.visuals.thicknessPivot = std::clamp((float)nri_ptsmokethicknesspivot, 0.001f, 8.0f);
	settings.visuals.thicknessSteps = (float)std::clamp((int)nri_ptsmokethicknesssteps, 1, 4);
	settings.visuals.flowHighlight = std::clamp((float)nri_ptsmokeflowhighlight, 0.0f, 1.0f);
	settings.visuals.flowSpeedReference = std::clamp((float)nri_ptsmokeflowspeedreference, 1.0f, 256.0f);
	settings.visuals.curlHighlight = std::clamp((float)nri_ptsmokecurlhighlight, 0.0f, 1.0f);
	settings.visuals.curlReference = std::clamp((float)nri_ptsmokecurlreference, 0.01f, 16.0f);
	settings.visuals.compressionSculpt = std::clamp((float)nri_ptsmokecompressionsculpt, -1.0f, 1.0f);
	settings.visuals.divergenceReference = std::clamp((float)nri_ptsmokedivergencereference, 0.01f, 16.0f);
	settings.visuals.bandStrength = std::clamp((float)nri_ptsmokebandstrength, 0.0f, 1.0f);
	settings.visuals.bandCount = (float)std::clamp((int)nri_ptsmokebandcount, 2, 9);
	settings.visuals.bandSoftness = std::clamp((float)nri_ptsmokebandsoftness, 0.02f, 0.49f);
	settings.visuals.contourStrength = std::clamp((float)nri_ptsmokecontourstrength, 0.0f, 1.0f);
	...
	settings.gridCurlEvolution = std::clamp((float)nri_ptsmokegridcurlevolution, 0.0f, 16.0f);
	settings.gridVorticity = std::clamp((float)nri_ptsmokegridvorticity, 0.0f, 16.0f);
