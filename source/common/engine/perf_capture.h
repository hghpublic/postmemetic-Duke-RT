...
struct PerfCompactNriStats
{
	...
	uint32_t traceRuntimeLightShadowRetained = 0, traceRuntimeLightShadowReplaced = 0, traceRuntimeLightShadowExpired = 0;
	uint64_t traceRuntimeLightShadowRetainedKeyHash = 0, traceRuntimeLightShadowReplacedKeyHash = 0, traceRuntimeLightShadowExpiredKeyHash = 0;
...
struct PerfCompactGpuTiming
{
	...
	double smokeTransientBinsMs = 0.0, smokeTransientLightBuildMs = 0.0, smokeTransientMaterializeMs = 0.0;
	...
	double SmokeDetailTotalMs() const
	{
		return smokeGridAllocateMs + smokeGridInitializeMs + smokeGridDepositMs + smokeGridHaloMs +
			...
			smokeAnalyticMaterializeMs + smokeTransientBinsMs + smokeTransientLightBuildMs + smokeTransientMaterializeMs +
