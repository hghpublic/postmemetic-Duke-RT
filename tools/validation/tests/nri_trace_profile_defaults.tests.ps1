...
Assert-Contract -Condition ($configVersion.Success -and [int]$configVersion.Groups[1].Value -ge 8) -Message "the trace-profile migration requires archived config version 8 or newer"
